...
function DarkHero() {
  return (
    <section style={{ position: 'relative', height: 900, background: DARK.bg, overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', right: 0, top: 0, bottom: 0, width: '55%', backgroundImage: `url(${window.__resources.bottleHeirs})`, backgroundSize: 'cover', backgroundPosition: 'center center', filter: 'brightness(1.05)' }} />
      {/* left text column */}
    ...
    <section style={{ background: DARK.bg, color: DARK.ink, padding: '180px 56px 160px' }}>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 100, alignItems: 'start' }}>
        <div>
          ...
          <div style={{ marginTop: 40, height: 320, backgroundImage: `url(${window.__resources.grapesHands})`, backgroundSize: 'cover', backgroundPosition: 'center' }} />
        </div>
