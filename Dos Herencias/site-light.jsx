...
function LightHero() {
  return (
    <section style={{ position: 'relative', height: 900, background: LIGHT.bg, overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', right: 0, top: 0, bottom: 0, width: '42%', backgroundImage: 'url(assets/bottle_top.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }} />
    ...
    <section style={{ background: LIGHT.bg, color: LIGHT.ink, padding: '180px 56px 160px' }}>
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: 100, alignItems: 'start' }}>
        <div>
          ...
          <div style={{ marginTop: 40, height: 320, backgroundImage: 'url(assets/vineyard.jpg)', backgroundSize: 'cover', backgroundPosition: 'center' }} />
        </div>
